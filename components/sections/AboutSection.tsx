...
const highlights = [
  {
    icon: BookOpen,
    title: "MBBS, 2016",
    desc: "North East Medical College & Hospital, under Sylhet MAG Osmani Medical University",
  },
  {
    icon: Stethoscope,
    title: "General Physician",
    desc: "Daktar Khana with 6+ years of hands-on clinical experience",
  },
  {
    icon: Award,
    title: "Certifications",
    desc: "CCD · CMU · DMU · PGT — specialised chronic disease management",
  },
  {
    icon: Heart,
    title: "Patient-First",
    desc: "Known for a warm bedside manner and holistic approach to care",
  },
];
      ...
      <div className="container-site">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <blockquote className="border-l-4 border-[var(--color-accent)] pl-4 py-1 bg-[var(--color-surface-light)] rounded-r-lg">
              <p className="text-body-lg italic text-[var(--color-text-secondary)]">
                &ldquo;Medicine is a form of art. Good health depends on how skilfully
                a doctor applies their knowledge when dealing with patients.&rdquo;
              </p>
            ...
            >
              {highlights.map(({ icon: Icon, title, desc }) => (
                <li
                  key={title}
                  className="flex gap-3 p-4 rounded-xl bg-[var(--color-surface-light)] hover:shadow-[var(--shadow-sm)] transition-shadow duration-200"
                >
                  <div
